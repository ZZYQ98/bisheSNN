function [ weights ] = train_step2( weights,layers,layers_buff,network_struct,total_time,learning_layer,st,STDP_per_layer,deta_STDP_minus,deta_STDP_plus,offset)%STDP_per_layer表示每层可以进行STDP学习的最大矩阵数量
